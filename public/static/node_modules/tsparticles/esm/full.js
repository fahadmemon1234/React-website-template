...
import {
    loadAbsorbersPlugin
} from "./Plugins/Absorbers";
import {
    loadEmittersPlugin
} from "./Plugins/Emitters";
import {
    loadExternalTrailInteraction
} from "./Interactions/External/Trail";
import {
    loadPolygonMaskPlugin
} from "./Plugins/PolygonMask";
import {
    loadRollUpdater
} from "./Updaters/Roll";
import {
...
import {
    loadTwinkleUpdater
} from "./Updaters/Twinkle";
import {
    loadWobbleUpdater
} from "./Updaters/Wobble";
export function loadFull(_x) {
    return _loadFull.apply(this, arguments);
}

function _loadFull() {
    _loadFull = _asyncToGenerator( /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(engine) {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 16:
                        _context.next = 18;
                        return loadPolygonMaskPlugin(engine);
