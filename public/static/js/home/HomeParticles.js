...
class HomeParticles extends Component {
    ...
    render() {
            ...
            return ( <
                    ...
                    items = {
                        ['home', 'service', 'about', 'portfolio', 'team', 'testimonial', 'blog', 'contact']
                    }
                        ...
                        SlideList.map((value, index) => ( <
                                    ...
                                    value.category ? < span > {
                                        ...
                                        value.title ? < h1 className = "title theme-gradient" > {
                                            ...
                                            value.description ? < p className = "description" > {
                                                    ...
                                                    value.buttonText ? < div className = "slide-btn" > < a className = "rn-button-style--2 btn-primary-color"
                                                    href = {
                                                        `${value.buttonLink}`
                                                    } > {
                                                        value.buttonText
                                ...
                                Slider { ...slickDot
                                    ...
                                    list.map((value, index) => ( <
                                        ...
                                        <
                                        a className = "rn-btn"
                                        href = "/portfolio-details" > Case Study < /a> <
                                        /div> <
                                        /div> <
                                        /div> <
                                ...
                                { /* Start Blog Area */ } <
                                div className = "rn-blog-area pt--120 pb--140 bg_color--1"
                                id = "blog" >
                                <
                                div className = "container" >
                                <
                                ...
                                Slider { ...slickDot
                                    ...
                                    PostList.map((value, i) => ( <
                                        ...
                                        h4 className = "title" > < a href = "/blog-details" > {
                                            value.title
                                        } < /a></h
                                        4 >
                                        <
